import { a as ie, k as be, l as Ae } from "./chunk-GFRIAK4R.js";
import {
  $a as G,
  Bb as te,
  Ga as M,
...
var xe = (() => {
  ...
  z = new v("");
var Qe = { provide: z, useExisting: h(() => Pe), multi: !0 };
function et() {
  let n = ie() ? ie().getUserAgent() : "";
    ...
    class n extends xe {
      ...
      constructor(e, i, r) {
        super(e, i),
          ...
          this._compositionMode == null && (this._compositionMode = !et());
      }
      writeValue(e) {
        let i = e ?? "";
...
function rt(n) {
  return ue(n.value) || nt.test(n.value) ? null : { email: !0 };
}
function st(n) {
  return (t) => {
    let e = t.value?.length ?? Re(t.value);
    return e === null || e === 0
      ? null
      : e < n
...
function Be(n) {
  return n.map((t) => (at(t) ? t : (e) => t.validate(e)));
}
function lt(n) {
  if (!n) return null;
  let t = n.filter(je);
...
function ut(n) {
  ...
  return t.length == 0
    ...
    : function (e) {
        let i = Ue(e, t).map(Ge);
        return _e(i).pipe(me(Te));
      };
}
function ce(n) {
  return n != null ? ut(Be(n)) : null;
}
function Me(n, t) {
...
var H = class {
  ...
  dn = c(d({}, ht), { "[class.ng-submitted]": "isSubmitted" }),
  cn = (() => {
    class n extends L {
      constructor(e) {
        super(e);
...
function He(n) {
  return (Z(n) ? n.validators : n) || null;
}
function ft(n) {
  return Array.isArray(n) ? de(n) : n || null;
}
function Le(n, t) {
  return (Z(t) ? t.asyncValidators : n) || null;
}
function pt(n) {
...
function mt(n, t, e) {
  n._forEachChild((i, r) => {
    if (e[r] === void 0) throw new k(1002, "");
  });
}
var W = class {
    _pendingDirty = !1;
    ...
    get status() {
      return m(this.statusReactive);
    }
    set status(t) {
      m(() => this.statusReactive.set(t));
    }
    _status = w(() => this.statusReactive());
    ...
    errors;
    get pristine() {
      return m(this.pristineReactive);
    }
    set pristine(t) {
      m(() => this.pristineReactive.set(t));
    }
    _pristine = w(() => this.pristineReactive());
    pristineReactive = b(!0);
    get dirty() {
      return !this.pristine;
    }
    get touched() {
      return m(this.touchedReactive);
    }
    set touched(t) {
      m(() => this.touchedReactive.set(t));
    }
    _touched = w(() => this.touchedReactive());
    touchedReactive = b(!1);
    get untouched() {
      return !this.touched;
    }
    ...
    removeValidators(t) {
      this.setValidators(Fe(t, this._rawValidators));
    }
    removeAsyncValidators(t) {
      this.setAsyncValidators(Fe(t, this._rawAsyncValidators));
    }
    hasValidator(t) {
      return B(this._rawValidators, t);
    }
    hasAsyncValidator(t) {
      return B(this._rawAsyncValidators, t);
    }
    clearValidators() {
      this.validator = null;
    }
    ...
    markAsTouched(t = {}) {
      ...
      this._parent &&
        !t.onlySelf &&
        this._parent.markAsTouched(c(d({}, t), { sourceControl: i })),
    ...
    markAsDirty(t = {}) {
      ...
      this._parent &&
        !t.onlySelf &&
        this._parent.markAsDirty(c(d({}, t), { sourceControl: i })),
    ...
    markAsPending(t = {}) {
      ...
      t.emitEvent !== !1 &&
        (this._events.next(new C(this.status, e)),
        this.statusChanges.emit(this.status)),
        this._parent &&
          !t.onlySelf &&
          this._parent.markAsPending(c(d({}, t), { sourceControl: e }));
    }
    disable(t = {}) {
      ...
      (this.status = S),
        (this.errors = null),
        this._forEachChild((r) => {
          r.disable(c(d({}, t), { onlySelf: !0 }));
        }),
        this._updateValue();
      let i = t.sourceControl ?? this;
      t.emitEvent !== !1 &&
        (this._events.next(new $(this.value, i)),
        this._events.next(new C(this.status, i)),
        this.valueChanges.emit(this.value),
        this.statusChanges.emit(this.status)),
        this._updateAncestors(c(d({}, t), { skipPristineCheck: e }), this),
    ...
    updateValueAndValidity(t = {}) {
      if ((this._setInitialStatus(), this._updateValue(), this.enabled)) {
        ...
        (this.errors = this._runValidator()),
          ...
          (this.status === I || this.status === y) &&
            this._runAsyncValidator(i, t.emitEvent);
      }
      let e = t.sourceControl ?? this;
      t.emitEvent !== !1 &&
        (this._events.next(new $(this.value, e)),
        this._events.next(new C(this.status, e)),
        this.valueChanges.emit(this.value),
        this.statusChanges.emit(this.status)),
        this._parent &&
    ...
    _setInitialStatus() {
      this.status = this._allControlsDisabled() ? S : I;
    }
    _runValidator() {
    ...
    _updateControlsErrors(t, e, i) {
      (this.status = this._calculateStatus()),
        ...
        (t || i) && this._events.next(new C(this.status, e)),
    ...
    _calculateStatus() {
      return this._allControlsDisabled()
        ...
        : this.errors
        ? U
        : this._hasOwnPendingAsyncValidator || this._anyControlsHaveStatus(y)
        ? y
    ...
    _updatePristine(t, e) {
      ...
      (this.pristine = i),
        ...
        r && this._events.next(new O(this.pristine, e));
    }
    _updateTouched(t = {}, e) {
      (this.touched = this._anyControlsTouched()),
        this._events.next(new x(this.touched, e)),
    ...
    _setUpdateStrategy(t) {
      Z(t) && t.updateOn != null && (this._updateOn = t.updateOn);
    }
...
var he = new v("", { providedIn: "root", factory: () => fe }),
  fe = "always";
function _t(n, t) {
  return [...t.path, n];
}
...
function yt(n, t) {
  t.valueAccessor.registerOnChange((e) => {
    (n._pendingValue = e),
      (n._pendingChange = !0),
      (n._pendingDirty = !0),
      n.updateOn === "change" && qe(n, t);
  });
}
function Ct(n, t) {
  t.valueAccessor.registerOnTouched(() => {
    (n._pendingTouched = !0),
      n.updateOn === "blur" && n._pendingChange && qe(n, t),
...
function Et(n, t) {
  ...
  return (
    t.forEach((s) => {
      s.constructor === Pe ? (e = s) : At(s) ? (i = s) : (r = s);
    }),
    r || i || e || null
  );
}
var Ft = { provide: V, useExisting: h(() => wt) },
  N = Promise.resolve(),
  wt = (() => {
    class n extends V {
      callSetDisabledState;
      get submitted() {
        return m(this.submittedReactive);
      }
      ...
      addControl(e) {
        N.then(() => {
          ...
          (e.control = i.registerControl(e.name, e.control)),
            $e(e.control, e, this.callSetDisabledState),
      ...
      static ɵfac = function (i) {
        return new (i || n)(o(D, 10), o(ke, 10), o(he, 8));
      };
      static ɵdir = l({
        type: n,
        selectors: [
  ...
  constructor(t = null, e, i) {
    super(He(e), Le(i, e)),
      ...
      Z(e) &&
        ...
        (Se(t) ? (this.defaultValue = t.value) : (this.defaultValue = t));
  }
  setValue(t, e = {}) {
...
var St = { provide: P, useExisting: h(() => Nt) },
  Ne = Promise.resolve(),
  Nt = (() => {
    class n extends P {
      _changeDetectorRef;
      ...
      _setUpStandalone() {
        $e(this.control, this, this.callSetDisabledState),
      ...
      _getPath(e) {
        return this._parent ? _t(e, this._parent) : [e];
      }
      static ɵfac = function (i) {
        return new (i || n)(
          o(V, 9),
...
var Ot = { provide: z, useExisting: h(() => Ze), multi: !0 };
function ze(n, t) {
  return n == null
    ? `${t}`
...
var Ze = (() => {
    class n extends le {
      ...
      writeValue(e) {
        this.cdr.markForCheck(), (this.value = e);
    ...
    class n {
      ...
      set ngValue(e) {
        this._select != null &&
          ...
          this._setElementValue(ze(this.id, e)),
  ...
  Pt = { provide: z, useExisting: h(() => Xe), multi: !0 };
function Oe(n, t) {
  return n == null
    ? `${t}`
    : (typeof t == "string" && (t = `'${t}'`),
        ...
        this.onChange = (i) => {
          ...
          if (s !== void 0) {
            ...
            for (let p = 0; p < a.length; p++) {
              let R = a[p],
                Y = this._getOptionValue(R.value);
              r.push(Y);
            }
          } else {
            let a = i.options;
            for (let p = 0; p < a.length; p++) {
              let R = a[p];
              if (R.selected) {
                let Y = this._getOptionValue(R.value);
                r.push(Y);
              }
            }
          }
  ...
  mn = (() => {
    class n {
      ...
      set ngValue(e) {
        this._select != null &&
          ((this._value = e),
          this._setElementValue(Oe(this.id, e)),
...
var X = (() => {
  class n {
    ...
    ngOnChanges(e) {
      if (this.inputName in e) {
        ...
        (this._enabled = this.enabled(i)),
          (this._validator = this._enabled ? this.createValidator(i) : re),
    ...
    static ɵdir = l({ type: n, features: [Q] });
  }
  return n;
})();
var jt = { provide: D, useExisting: h(() => Gt), multi: !0 };
var Gt = (() => {
  class n extends X {
    required;
    inputName = "required";
    normalizeInput = T;
    createValidator = (e) => it;
    enabled(e) {
      return e;
    }
    static ɵfac = (() => {
    ...
    static ɵdir = l({
      ...
      hostVars: 1,
      hostBindings: function (i, r) {
        i & 2 && G("required", r._enabled ? "" : null);
      },
...
var Tt = { provide: D, useExisting: h(() => Ut), multi: !0 },
  Ut = (() => {
    class n extends X {
      email;
      inputName = "email";
      normalizeInput = T;
      createValidator = (e) => rt;
      enabled(e) {
        return e;
      }
      static ɵfac = (() => {
  ...
  Bt = { provide: D, useExisting: h(() => Ht), multi: !0 },
  Ht = (() => {
    class n extends X {
      minlength;
      inputName = "minlength";
      normalizeInput = (e) => kt(e);
      createValidator = (e) => st(e);
      static ɵfac = (() => {
        let e;
        return function (r) {
          return (e || (e = g(n)))(r || n);
      ...
      static ɵdir = l({
        ...
        hostVars: 1,
        hostBindings: function (i, r) {
          i & 2 && G("minlength", r._enabled ? r.minlength : null);
        },
...
var Lt = { provide: D, useExisting: h(() => $t), multi: !0 },
  $t = (() => {
    class n extends X {
      pattern;
      inputName = "pattern";
      normalizeInput = (e) => e;
      createValidator = (e) => ot(e);
      static ɵfac = (() => {
        let e;
        return function (r) {
          return (e || (e = g(n)))(r || n);
      ...
      static ɵdir = l({
        ...
        hostVars: 1,
        hostBindings: function (i, r) {
          i & 2 && G("pattern", r._enabled ? r.pattern : null);
        },
...
var _n = (() => {
  class n {
    static withConfig(e) {
      return {
        ngModule: n,
        providers: [{ provide: he, useValue: e.callSetDisabledState ?? fe }],
      };
    }
    static ɵfac = function (i) {
      return new (i || n)();
...
var Ke = class n {
  ...
  baseUrl = Ye.apiUrl;
  httpOptions = { headers: new be({ "Content-Type": "application/json" }) };
  submitContactForm(t) {
    return this.http.post(`${this.baseUrl}/contact`, t, this.httpOptions);
  }
  submitCareerForm(t) {
    return this.http.post(`${this.baseUrl}/careers`, t, this.httpOptions);
  }
  checkHealth() {
    return this.http.get(`${this.baseUrl}/health`);
  }
  static ɵfac = function (e) {
    return new (e || n)(ve(Ae));
  };
